        ...
        function View() {
            ...
            function loadConfiguration() {
                ...
                return ApiClient.getPluginConfiguration(TemplateConfig.pluginUniqueId).then(function (config) {
                    ...
                    container.querySelector('#MatchByFileHash').checked = config.Dandan.MatchByFileHash;

                    // 弹幕下载选项
                    if (config.DownloadOption) {
                        container.querySelector('#EnableEpisodeCountSame').checked = config.DownloadOption.EnableEpisodeCountSame;
                    }
            ...
            container.querySelector('#TemplateConfigForm')
                .addEventListener('submit', function (e) {
                    ...
                    ApiClient.getPluginConfiguration(TemplateConfig.pluginUniqueId).then(function (config) {
                        ...
                        dandan.MatchByFileHash = container.querySelector('#MatchByFileHash').checked;
